...
namespace DataLayer.Migrations
{
    ...
    [Migration("20250801190425_RemoveIncorrectRelationships2")]
    partial class RemoveIncorrectRelationships2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.LabPicture", b =>
                {
                    ...
                    b.Property<string>("LabPictureName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DataLayer.Entities.PaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MomoExtraData")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("MomoResponseTime")
                        .HasColumnType("datetime2");

                    b.Property<string>("MomoResultCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MomoSignature")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DataLayer.Entities.PaymentTransaction", b =>
                {
                    b.HasOne("DataLayer.Entities.Appointment", "Appointment")
                        ...
                        .HasForeignKey("DataLayer.Entities.PaymentTransaction", "AppointmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataLayer.Entities.PrescriptionItem", b =>
                {
                    ...
                    b.HasOne("DataLayer.Entities.TreatmentStage", null)
